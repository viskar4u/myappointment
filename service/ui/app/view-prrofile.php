...
<div class="container section_wrapper">
  ...
  <div class="row mg-t-p">
      ...
      <div class="col-md-4">
        <div class="dr_viw_prfimg"> 
           ...
           <img  src="<?php echo WEB_ROOT?>service/public/z_uploads/doctor/<?php 
              echo $imageName;?>" alt="">
           <?php }else{?>
           <a href="<?php echo WEB_ROOT;?>service/public/z_uploads/doctor/<?php echo $profileImage;?>" class="html5lightbox" data-group="mygroup" data-thumbnail="<?php echo WEB_ROOT?>service/public/z_uploads/doctor/<?php echo $profileImage;?>" ><img src="<?php echo WEB_ROOT?>service/public/z_uploads/doctor/thumbnail/<?php echo $profileImage;?>" /></a>
           <?php } } else {?>
        ...
        <?php if(!empty($resImage)){?>
        <div id="slider1">
           <div class="thumbelina-but horiz leftt"><a href="javascript:void(0);"> <img src="<?php echo WEB_ROOT?>service/public/images/thumb_arow_lft.png" alt=""></a> </div>
           <ul>
              <?php
                 foreach($resImage as $keys=>$value){
                 ?>
              <li> 
                 <?php
                    if($value['type']==0 && $value['set_profile']!=1){
                      ?>
              <li>
                 <a href="<?php echo WEB_ROOT;?>service/public/z_uploads/doctor/<?php echo $value['name'];?>" class="html5lightbox" data-group="mygroup" data-thumbnail="<?php echo WEB_ROOT?>service/public/z_uploads/doctor/<?php echo $value['name'];?>" ><img src="<?php echo WEB_ROOT?>service/public/z_uploads/doctor/thumb/<?php echo $value['name'];?>" /></a>
                 <?php }else {
                    if($value['type']==1){
                    ?>
                 <a href="<?php echo WEB_ROOT;?>service/public/z_uploads/doctor/<?php echo $value['name'];?>" class="html5lightbox" data-group="mygroup" data-thumbnail="<?php echo WEB_ROOT?>service/public/images/video.jpg" ><img src="<?php echo WEB_ROOT?>service/public/images/video.jpg" style="height:40px;width:42px;" /></a>
                 <?php } } ?>
              </li>
              <?php } ?>
           </ul>
           <div class="thumbelina-but horiz rightt"><a href="javascript:void(0);"><img src="<?php echo WEB_ROOT?>service/public/images/thumb_arow.png" alt=""></a></div>
        </div>
        <?php } ?>
      </div>
      <div class="col-md-8">
    ...
    <div class="col-md-5 col-sm-5 col-xs-12">
      <div id="map" style="width: 100%; height: 294px;"></div>
    </div>
  </div>

  <div class="row dg_div mg-t-p">
      <div class="col-md-5 col-sm-5 col-xs-12">
        <fieldset class="registration">
               <h1> Book an Appointment </h1>
               <label class="subname2"> Will you use insurance?  </label>
               ...
               <label class="subname2"> Insurance </label>
               <div class="drop-select" >
               ...
               <label class="subname2"> What's the reason for your visit? </label>
               <div class="drop-select">
               ...
               <label class="subname2"> Click a time in the calendar to book</label>
        </fieldset>
      </div>
      <div class="col-md-7 col-sm-7 col-xs-12">
        <div class="col-md-1 col-sm-1 col-xs-0 calender-contorl padding-0"><img id='prev' src="<?php echo WEB_ROOT?>service/public/images/images/Pre.png"></div>
        <div class="col-md-10 col-sm-10 col-xs-12 calender date padding-0"> 
        </div>
        <div class="col-md-1 col-sm-1 col-xs-0 calender-contorl padding-0"> <img id="next" src="<?php echo WEB_ROOT?>service/public/images/images/Nex.png"></div>
      </div>
  </div>
  ...
  <div class="row dg_div mg-t-p">
    ...
    <div class="col-md-5 col-sm-5 col-xs-12" style="border-left: 2px solid rgb(230, 230, 230);"> 
...
<script type="text/javascript">
    ...
    var locations = [
      ['<div style=\"width:100%\"><?php echo $result['address'];?></div>', -33.923036, 151.259052]/*,
